...
import app.nakajo.a00100.job.a00100.load.job.request.load.usage.reader.Readera;
...
public class Usage {
	...
	public static Usage getInstance() {
		return (m_instance == null ? m_instance = new Usage() : m_instance);
	}
	...
	public static class _Current {
		...
		void insert() throws Exception {
			try (val stmt = JDBCUtils.createStatement()) {
				...
				try (val reader = Readera.getInstance()) {
