		...
		Collection<Object[]> query() throws Exception {
			...
			+ "(\n"
				+ "SELECT NULL::VARCHAR AS data_type,\n"
					...
					+ "t10.after_180_day,\n"
					+ "t10.last_6_month\n"
						+ "+ COALESCE( LAG( t10.last_6_month, 1 ) OVER ( ORDER BY t10.usage_month ), 0 )\n"
						+ "+ COALESCE( LAG( t10.last_6_month, 2 ) OVER ( ORDER BY t10.usage_month ), 0 ) AS last_month,\n"
					+ "t10.after_60_day\n"
						+ "+ COALESCE( LAG( t10.after_60_day, 1 ) OVER ( ORDER BY t10.usage_month ), 0 )\n"
						+ "+ COALESCE( LAG( t10.after_60_day, 2 ) OVER ( ORDER BY t10.usage_month ), 0 ) AS after_month\n"
				...
				+ "SELECT 'ALL',\n"
					...
					+ "t10.all_last_6_month\n"
						+ "+ COALESCE( LAG( t10.all_last_6_month, 1 ) OVER ( ORDER BY t10.usage_month ), 0 )\n"
						+ "+ COALESCE( LAG( t10.all_last_6_month, 2 ) OVER ( ORDER BY t10.usage_month ), 0 ),\n"
					+ "t10.all_after_60_day\n"
						+ "+ COALESCE( LAG( t10.all_after_60_day, 1 ) OVER ( ORDER BY t10.usage_month ), 0 )\n"
						+ "+ COALESCE( LAG( t10.all_after_60_day, 2 ) OVER ( ORDER BY t10.usage_month ), 0 )\n"
				+ "FROM tmp_repeat_report AS t10\n"
			+ ") AS t10\n"
