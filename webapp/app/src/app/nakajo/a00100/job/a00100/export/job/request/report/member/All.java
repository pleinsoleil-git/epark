						...
						+ "(\n"
							+ "SELECT 'ALL' AS data_type,\n"
								...
								+ "t20.all_last_6_month\n"
									...
									+ "+ COALESCE( LAG( t20.all_last_6_month, 2 ) OVER ( PARTITION BY t20.evaluation ORDER BY t20.usage_month ), 0 ) AS last_6_month,\n"
								+ "t20.all_after_60_day\n"
									+ "+ COALESCE( LAG( t20.all_after_60_day, 1 ) OVER ( PARTITION BY t20.evaluation ORDER BY t20.usage_month ), 0 )\n"
									+ "+ COALESCE( LAG( t20.all_after_60_day, 2 ) OVER ( PARTITION BY t20.evaluation ORDER BY t20.usage_month ), 0 ) AS after_60_day\n"
							+ "FROM s_usage_month AS t10\n"
