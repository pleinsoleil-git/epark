		...
		Collection<Object[]> query() throws Exception {
			...
			sql = "SELECT t10.data_type,\n"
				...
				+ "CASE\n"
					...
					+ "ELSE TRUNC( t10.after_30_day / t10.last_6_month, 4 )\n"
				+ "END,\n"
				+ "CASE\n"
					+ "WHEN t10.last_6_month = 0 THEN 0\n"
					+ "ELSE TRUNC( t10.after_60_day / t10.last_6_month, 4 )\n"
				+ "END,\n"
				+ "CASE\n"
					+ "WHEN t10.last_6_month = 0 THEN 0\n"
					+ "ELSE TRUNC( t10.after_90_day / t10.last_6_month, 4 )\n"
				+ "END,\n"
				+ "CASE\n"
					+ "WHEN t10.last_6_month = 0 THEN 0\n"
					+ "ELSE TRUNC( t10.after_120_day / t10.last_6_month, 4 )\n"
				+ "END,\n"
				+ "CASE\n"
					+ "WHEN t10.last_6_month = 0 THEN 0\n"
					+ "ELSE TRUNC( t10.after_150_day / t10.last_6_month, 4 )\n"
				+ "END,\n"
				+ "CASE\n"
					+ "WHEN t10.last_6_month = 0 THEN 0\n"
					+ "ELSE TRUNC( t10.after_180_day / t10.last_6_month, 4 )\n"
				+ "END,\n"
				+ "NULL,\n"
				+ "t10.last_6_month,\n"
				+ "t10.after_30_day,\n"
			...
			+ "FROM\n"
			+ "(\n"
				+ "SELECT 'ALL' AS data_type,\n"
					+ "t10.evaluation,\n"
					+ "t10.usage_month,\n"
					+ "t10.all_last_6_month AS last_6_month,\n"
					+ "t10.all_after_30_day AS after_30_day,\n"
					+ "t10.all_after_60_day AS after_60_day,\n"
					+ "t10.all_after_90_day AS after_90_day,\n"
					+ "t10.all_after_120_day AS after_120_day,\n"
					+ "t10.all_after_150_day AS after_150_day,\n"
					+ "t10.all_after_180_day AS after_180_day,\n"
					+ "t10.all_last_6_month\n"
						+ "+ COALESCE( LAG( t10.all_last_6_month, 1 ) OVER ( PARTITION BY t10.evaluation ORDER BY t10.usage_month ), 0 )\n"
						+ "+ COALESCE( LAG( t10.all_last_6_month, 2 ) OVER ( PARTITION BY t10.evaluation ORDER BY t10.usage_month ), 0 ) AS last_month,\n"
