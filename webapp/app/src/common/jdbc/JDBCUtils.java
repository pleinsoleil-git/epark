...
public class JDBCUtils {
	...
	public static <T> List<T> query(final String sql, final BeanListHandler<T> rsh, final Collection<Object> params)
			throws Exception {
		return query(getConnection(), sql, rsh, params);
	}
	...
	public static <T> T query(final JDBCConnection conn, final String sql, final ResultSetHandler<T> rsh)
			throws Exception {
		return query(conn.getConnection(), sql, rsh);
	}
	...
	public static <T> T query(final Connection conn, final String sql, final ResultSetHandler<T> rsh,
			final Collection<Object> params)
			throws Exception {
		return (new QueryRunner()).query(conn, sql, rsh, params.toArray());
	}
	...
	public static <T> T query(final String sql, final ResultSetHandler<T> rsh, final Collection<Object> params)
			throws Exception {
		return query(getConnection(), sql, rsh, params);
	}
	...
	public static int execute(final Connection conn, final String sql, final Collection<Object> params)
			throws Exception {
	...
	public static void truncateTable(final Connection conn, final String tableName, final boolean cascade)
			throws Exception {
	...
	public static void truncateTable(final JDBCConnection conn, final String tableName, final boolean cascade)
			throws Exception {
